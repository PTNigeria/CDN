...
Techie.error( "No HTMLElement provided.", Techie.isHTML(obj), 223);

a(type(fn, "function"))

Techie.error( fn+" is not a valid Techie function", type(fn, "function"), 227)
...
obj = obj || this;
if (Techie.isList(obj)) {obj = obj[0];}
Techie.error( "No HTMLElement provided.", Techie.isHTML(obj), 235);
...
hover: function hover(fnIn, fnOut, e) {
	...
	forEach(function (e){
Techie.error( "No HTMLElement provided.", Techie.isHTML(e), 245);
	Techie.error( fnIn + " is not a valid function", plain.functions(fnIn), 246);
 ...
 return function funny ( numbers  ) {
    ...
    var plain = {
       ...
       isEmptyObject: function isEmptyObject ( obj ) {
        ...
        strings: function strings(value) {
...
prevObject, nextObject, nodes = [], length, toString, wrapper;
...
Techie.ready( selector );
 return this;
} else if (str == "[object Array]" || str == "[object Object]" || str == "[object Techie]") {
    if(str != "[object Techie]"){ 
     ...
     DefineProperty( this, "length", selector.length || null, false ); return this;
    }
...
'font-size': '1em','z-index': 1,'text-align': 'center'
     ...
     def2 = {display: 'none'};
        ...
        while( counter < 5 ){
            if (Kaller != null) { stack.push(Kaller); }counter++; caller = caller.caller;
    }
...
throw {
            name: "Techie API",
            type: "SyntaxExrror",
            origin: caller.callee.name || caller.callee.toString(),
            method: caller.name || caller.toString(),
            message: msg,
            stack: stack,
            line: "<a href='Techie.js:"+ line + "'>line</a>"
                };

        	// throw new Error( "=>Techie."+method+" Syntax error:: "+ msg+line );
        }
...
function attributesTransfer( old_e, new_e ) {
        ...
        Techie.error( isHTML(o) && isHTML(n), 2853 );
...
return this;
 ...
 forEach(function(k, j, o) { if (e == j) {store[e] = k;stk.push(k); } else if (e == k) {store[e] = j;stk.push(j); }}, arr);
    ...
    function createFrag(blob, context) {
        ...
        temp.innerHTML = blob;
         Techie.error("could not create the node from fragment.", !temp.firstChild, 2244);
    ...
    function type(datum, string) {
        if (type.isAtype(datum)) {
            if (string && string != null ) {
                ...
                } else { Techie.error( "pt.type({}, 'object'); //true, type(28); //number", null, 2520);
                }
            }
            return typeof(datum);
        }
...
mixin(type, 
    {
            isEmptyObject: function isEmptyObject ( obj ) {
                Techie.error( "object", types.primitives(obj) == false, 2531);
                var name;
                for ( name in obj ) {
                      return false;
                    }
...
Techie.error(  "string", !!strings.length, 2630 );
return {
   In: function(obj){ 
    obj = obj || this;
    ...
    Elements.props = {
     ...
     status: loadStatus(),
        ...
        serialize: function serialize(form) {
            form = form || this;
            Techie.error( "html", isHTML(form) || isCollection(form), 2751);
...
// HERE WE ARE
        empty: function emptyElement(e){
            e = isCollection(e) ? e : isHTML(e) ? [e]: new Error("html not valid");
            forEach (function(e){
...
return this;
        ...
        Remove: function Remove( element ) { //used to remove element or this using dom reomoveChild 
        ...
        RemoveAll: function RemoveAllChildren(e) {
            ...
            foreach(function(){
            Events.off(e);
            var newE = sapi.create(e.tagName);
            attributesTransfer(e, newE);//create an empty element in its place
            this.ReplaceChild(sapi.body, e, newE);
            },e);
            return this;
        },
...
return  this.stack;
        ...
        append: function append(element, nextSibling) { //Used to create nextSibling
           ...
           if (typeof nextSibling === "string") {
            ...
            Techie.error( "html", isHTML(nextSibling), 3142);
           forEach (function( element, index ) {
              element.parentNode.insertBefore(nextSibling, element.nextSibling);
         }, context);
            return this;
        ...
        prepend: function prepend(element, previousSibling, michael) { //used to create previousSibling
           ...
           if (typeof previousSibling === "string") {
            ...
            Techie.error( "html", isHTML(previousSibling), 3158);
           forEach (function( element, index ){
                       element.parentNode.insertBefore(previousSibling, element);
}, context);
            return this;
    ...
    forEach.call(context, function( context, index , array){
        ...
        Techie.error( child + " html", child.nodeType == 1, 3071);
        Techie.error( context + " html", context.nodeType == 1, 3072);
...
option = ( object && (object.nodeType || isCollection(object))) ? (option || "") : object; 
    ...
    function Children(parent) { //Children(body, 4)
        ...
        Techie.error( "No arguments supplied", arguments.length || thisB, 3309);
...
if (isList(parent)) {  parent = parent[0]; }
        Techie.error( parent + " is not object HTMLElement", parent && parent.nodeType, 3320 );
            (function Next(div) {
