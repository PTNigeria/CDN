...
////////////::::::::::::::ELEMENTS:::::::::::::::::::::::::::///////////////
    ...
    Elements.props = {
     ...
     status: loadStatus(),
        ...
        eachChild: function eachChild(fn, element, Thisarg) {a(element)
...
// HERE WE ARE
        ...
        e = e || this; 
            e = isCollection(e) ? e : isHTML(e) ? [e]: Techie.error("html", null, ln());
            forEach (function(e){
                Events.unbind(e, true); 
                Techie(e).eachChild.call(this,function(child){ a(child)
                    this.replaceChild(child, createFrag("<div>My fifle</div>"));
                });
